        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 md:gap-12 lg:gap-12">
          ...
          >
            ...
            <motion.div 
              ...
              className="absolute -top-4 sm:top-0 md:top-[5%] -left-2 sm:-left-4 md:-left-12 z-0 bg-slate-900/90 backdrop-blur-xl p-2 md:p-3 rounded-xl border border-white/10 shadow-2xl shadow-blue-500/10 min-w-[100px] sm:min-w-[110px] md:min-w-[160px] scale-75 origin-center"
            >
              {/* MacOS Window Dots */}
            ...
            <motion.div 
              ...
              className="absolute -bottom-4 sm:bottom-0 md:bottom-[5%] -right-2 sm:-right-4 md:-right-12 z-0 bg-slate-900/90 backdrop-blur-xl p-2 md:p-3 rounded-xl border border-white/10 shadow-2xl shadow-purple-500/10 min-w-[100px] sm:min-w-[110px] md:min-w-[160px] scale-75 origin-center"
            >
              {/* MacOS Window Dots */}
              <div className="flex items-center gap-1.5 mb-3">
                <div className="w-2.5 h-2.5 rounded-full bg-red-500/80"></div>
